    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-surface">
      <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="font-headline-lg text-headline-lg text-primary">Bem-vindo ao Visagê</h1>
          <p className="text-on-surface-variant mt-2 font-body-md">Acesse sua consultoria premium</p>
        </div>

        <form onSubmit={handleSubmit} className="bg-white p-8 rounded-3xl shadow-xl border border-outline-variant space-y-6">
          {error && (
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              type="email"
              required
              placeholder="ex: consultor@visage.app"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-primary text-on-primary py-5 rounded-2xl font-label-caps text-label-caps uppercase tracking-widest shadow-lg shadow-primary/20 active:scale-[0.98] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
          >
